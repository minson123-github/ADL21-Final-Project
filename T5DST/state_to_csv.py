...
if __name__ == '__main__':
	with open(sys.argv[1], 'r') as fp:
		raw_pred = json.load(fp)
	pred = {}
	for _id, domain_slots in raw_pred.items():
		pred[_id] = {}
		for domain_slot, value in domain_slots.items():
			if value != 'none':
				pred[_id][domain_slot] = value
	write_csv(pred, sys.argv[2])
