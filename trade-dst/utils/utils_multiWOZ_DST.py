...
EXPERIMENT_DOMAINS = ['Banks_2', 'Buses_1', 'Hotels_1', 'Services_1', 'Homes_1', 'Music_1', 'Music_3', 'Weather_1', 'Messaging_1', 'Homes_2', 'RideSharing_1', 'Media_1', 'Flights_4', 'train', 'RideSharing_2', 'Media_3', 'Flights_3', 'Movies_1', 'Services_4', 'Events_2', 'RentalCars_2', 'Flights_2', 'taxi', 'bus', 'RentalCars_3', 'attraction', 'Hotels_4', 'Buses_3', 'Music_2', 'RentalCars_1', 'Restaurants_1', 'Events_3', 'Restaurants_2', 'hospital', 'hotel', 'Calendar_1', 'Flights_1', 'Travel_1', 'Alarm_1', 'police', 'Services_2', 'Trains_1', 'Services_3', 'Hotels_2', 'Payment_1', 'Events_1', 'restaurant', 'Hotels_3', 'Buses_2', 'Media_2', 'Movies_3', 'Movies_2', 'Banks_1']
...
class Dataset(data.Dataset):
    ...
    def preprocess_domain(self, turn_domain):
        domains = {domain: i for i, domain in enumerate(EXPERIMENT_DOMAINS)}
